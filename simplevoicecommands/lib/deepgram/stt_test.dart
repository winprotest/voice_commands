...
class STTTestPage extends StatefulWidget {
  ...
  @override
  State<STTTestPage> createState() => _STTTestPage();
}

class _STTTestPage extends State<STTTestPage> {
  ...
  void _init() async {
    ...
    debugPrint('_hasPermission:$_hasPermission');
    if (!_hasPermission){
              ...
              child: Container(
                ...
                child: IgnorePointer(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      debugPrint('onPressed _isListening:$_isListening');
                      setState(() {
